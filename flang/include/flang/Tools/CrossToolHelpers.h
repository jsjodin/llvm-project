...
[[maybe_unused]] static mlir::omp::OffloadModuleOpts
makeOffloadModuleOpts(Fortran::common::LangOptions &Opts) {
  return mlir::omp::OffloadModuleOpts(
      Opts.OpenMPTargetDebug, Opts.OpenMPTeamSubscription,
      Opts.OpenMPThreadSubscription, Opts.OpenMPNoThreadState,
      Opts.OpenMPNoNestedParallelism, Opts.OpenMPIsTargetDevice,
      Opts.OpenMPIsGPU, Opts.OpenMPForceUSM, Opts.OpenMPVersion,
      Opts.OMPHostIRFile, Opts.OMPTargetTriples, Opts.NoGPULib);
}
